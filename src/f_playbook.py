# ==============================================================================
# HARMONIZED AI: DAILY INTRADAY EXECUTION PLAYBOOK (F EQUITY)
# Target Session: Wednesday, July 22, 2026
# Asset Class: Direct Equity / Shares
# Pre-Market Spot: $13.99 | VWAP Anchor: $14.05
# Enforced Risk Budget: $30.00 | Dynamic ATR Volatility Buffer: $0.15
# ==============================================================================
...
PLAYBOOK_CONFIG = {
    ...
    "spot_anchor": 13.99,
    "vwap_anchor": 14.05,
    "support_zone": [13.85, 14.0],
    "resistance_zone": [14.4, 14.6],
...
if __name__ == "__main__":
    print(f"[F Playbook Verified] Date: 2026-07-22 | Risk Cap: $30.00")
